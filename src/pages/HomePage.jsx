...
const HomePage = () => {
  ...
  return (
    ...
    <div className="home-scroll-container">
      ...
      <div className="Page-container">
        <div className="hero-section">
            <img src="\images\image.jpg" className="abc"height="500px" width="1000px"></img>
    ...
    <li id="coll">**Strong Placements**: Excellent career opportunities with leading companies.</li>
          ...
          <img src="\images\campus-life-Crkero7B.jpg" alt="Campus View 1" className="gallery-image" />
          <img src="\images\students-studying-DbLGuwF_.jpeg" alt="Campus View 2"className="gallery-image taller-image"/>
